...
This notebook is used to overlap genes interesting SNPs and get `.fasta` files for your favorite pupfish genes.

Plyranges has lots of advanced options for overlapping genomic intervalsYou can find out more about plyranges here:  
https://bioconductor.org/packages/devel/bioc/vignettes/plyranges/inst/doc/an-introduction.html  
...
exons <- read.table("D:/Cyprinodon/bronto/c_brontotheroides.all.renamed.putative_function.exons_only_reformated_known_final.saf", header = FALSE, stringsAsFactors = FALSE)
...
# Notice that there are two regions of the genome called gpa33.  
