...
```{r, eval = TRUE, message=FALSE, warning=FALSE, error=TRUE ,fig.width= 10, fig.height= 7}
#setwd("C:/Users/jmcgirr/Documents/GitHub/fishfASE/markdown/data_files")
...
inheritance_and_ase <- read.table("C:/Users/jmcgirr/Documents/GitHub/fishfASE/markdown/data_files/inheritance_and_ase_crp_8dpf.txt", header = TRUE, stringsAsFactors = FALSE)
...
###
inheritance_and_ase <- read.table("C:/Users/jmcgirr/Documents/GitHub/fishfASE/markdown/data_files/inheritance_and_ase_osp_8dpf.txt", header = TRUE, stringsAsFactors = FALSE)
...
###
inheritance_and_ase <- read.table("C:/Users/jmcgirr/Documents/GitHub/fishfASE/markdown/data_files/inheritance_and_ase_crp_48hpf.txt", header = TRUE, stringsAsFactors = FALSE)
...
###
inheritance_and_ase <- read.table("C:/Users/jmcgirr/Documents/GitHub/fishfASE/markdown/data_files/inheritance_and_ase_osp_48hpf.txt", header = TRUE, stringsAsFactors = FALSE)
...
inheritance_and_ase <- read.table("C:/Users/jmcgirr/Documents/GitHub/fishfASE/markdown/data_files/inheritance_all_genes_crp_and_osp_8dpf.txt", header = TRUE, stringsAsFactors = FALSE)
...
inheritance_and_ase <- read.table("C:/Users/jmcgirr/Documents/GitHub/fishfASE/markdown/data_files/inheritance_all_genes_crp_and_osp_48hpf.txt", header = TRUE, stringsAsFactors = FALSE)
