...
#ase_dir <- "C:/Users/jmcgirr/Desktop/cluster_test/"
#cts_dir <- "C:/Users/jmcgirr/Desktop/cluster_test/"
#indiv <- "OYE3"
...
write.table(ase,paste(ase_dir,indiv,"_mbased_ase_unphased.txt",sep = ""), quote = FALSE, row.names = FALSE, sep = "	")
