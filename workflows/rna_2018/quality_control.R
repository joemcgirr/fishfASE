...
#tiff("C:/Users/jmcgirr/Documents/all_2018_samples/manuscript_figs/supp/prop_reads_assigned_stage.tiff", width = 4, height = 4, units = 'in', res = 1000)
p1
#dev.off()
...
p1 <- ggboxplot(box_plts, "species_region_lake_cross_with_species", "total_norm_cts",color = cols, ylab = "total normalized counts\n", xlab="")+
  ...
  scale_x_discrete(labels= c("generalists","new\nprovidence", "species\nhybrids","molluscivores", "north \ncarolina","outgroup\ngeneralist\nhybrids", "scale-eaters"))+
...
#summary(an)
#tiff("C:/Users/jmcgirr/Documents/all_2018_samples/manuscript_figs/supp/qc_norm_cts.tiff", width = 6, height = 4, units = 'in', res = 1000)
p1
#dev.off()
...
#summary(an)
#tiff("C:/Users/jmcgirr/Documents/all_2018_samples/manuscript_figs/supp/qc_gc_content.tiff", width = 6, height = 4, units = 'in', res = 1000)
p1
#dev.off()
...
#summary(an)
#tiff("C:/Users/jmcgirr/Documents/all_2018_samples/manuscript_figs/supp/qc_depth.tiff", width = 6, height = 4, units = 'in', res = 1000)
p1
#dev.off()
...
#summary(an)
#tiff("C:/Users/jmcgirr/Documents/all_2018_samples/manuscript_figs/supp/qc_tin.tiff", width = 6, height = 4, units = 'in', res = 1000)
p1
#dev.off()
...
#an <- aov(info$tin_median~info$species_region_lake_cross_with_species)
#summary(an)
#tiff("C:/Users/jmcgirr/Documents/all_2018_samples/manuscript_figs/supp/qc_dups.tiff", width = 6, height = 4, units = 'in', res = 1000)
p1
#dev.off()
